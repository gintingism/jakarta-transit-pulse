      ...
      >
        ...
        <div className="relative p-5 sm:p-6 bg-gradient-to-br from-sky-600/15 via-blue-600/10 to-indigo-600/15 border-b border-slate-200 dark:border-zinc-800/80">
          <button
            type="button"
            onClick={() => setChangelogModalOpen(false)}
            className="absolute top-4 right-4 p-1.5 rounded-xl text-slate-500 dark:text-zinc-400 hover:text-slate-800 dark:hover:text-white bg-white/80 dark:bg-zinc-800/80 hover:bg-slate-100 dark:hover:bg-zinc-700 transition-transform duration-150 ease-out active:scale-[0.95] focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none cursor-pointer border border-slate-200/80 dark:border-zinc-700"
        ...
        <div className="p-4 sm:p-4.5 bg-slate-50 dark:bg-zinc-950 border-t border-slate-200 dark:border-zinc-800/80 flex flex-wrap items-center justify-between gap-2.5">
          ...
          <button
            type="button"
            onClick={() => setChangelogModalOpen(false)}
            className="px-4 py-2 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-zinc-900 font-bold text-xs hover:bg-slate-800 dark:hover:bg-zinc-100 transition-transform duration-150 ease-out active:scale-[0.97] focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:outline-none cursor-pointer ml-auto"
          >
            Mengerti & Tutup
          </button>
        </div>
