      ...
      <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl p-4 shadow-xl">
        ...
        <div className="space-y-3.5">
            ...
            {routePlan?.destination && alarmTargetStopId !== routePlan.destination.id && (
              <div className="mt-2 flex items-center justify-between p-2 rounded-xl bg-sky-50/80 dark:bg-sky-950/40 border border-sky-200 dark:border-sky-800/60 text-xs">
                ...
                <button
                  ...
                  className="ml-2 shrink-0 py-1 px-2.5 text-[10.5px] font-bold bg-sky-600 hover:bg-sky-500 text-white rounded-lg transition shadow-xs cursor-pointer active:scale-95"
                >
                  Gunakan Ini
                </button>
              </div>
              ...
              {ALARM_STOPS.map((stop) => {
                ...
                return (
                  <button
                    ...
                    type="button"
                    onClick={() => handleSelectPreset(stop.value)}
                    className={`py-1.5 px-1.5 rounded-lg text-center transition cursor-pointer border flex flex-col items-center justify-center active:scale-95 ${
                      isSelected
          ...
          <button
            ...
            className={`w-full py-3 px-4 rounded-xl text-xs font-bold tracking-wide uppercase transition flex items-center justify-center gap-2 shadow-md cursor-pointer ${
              !alarmTargetStopId
                ? 'bg-slate-200 dark:bg-zinc-800 text-slate-400 dark:text-zinc-600 cursor-not-allowed'
                : isAlarmArmed
                ? 'bg-rose-50 dark:bg-rose-950/80 text-rose-700 dark:text-rose-200 border border-rose-300 dark:border-rose-800 hover:bg-rose-100 dark:hover:bg-rose-900 active:scale-98'
        ...
        <div className="flex gap-2">
          {isSimulatingApproach ? (
            <button
              ...
              className="flex-1 py-2 px-3 bg-rose-50 dark:bg-rose-950/80 hover:bg-rose-100 dark:hover:bg-rose-900 border border-rose-300 dark:border-rose-800 text-rose-700 dark:text-rose-200 text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 transition cursor-pointer"
            >
            ...
            <button
              ...
              className="flex-1 py-2 px-3 bg-sky-600 hover:bg-sky-500 text-white text-xs font-bold rounded-xl flex items-center justify-center gap-1.5 transition shadow-sm active:scale-98 cursor-pointer"
            >
      ...
      <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl p-3.5 space-y-2.5 text-[11px]">
        ...
        <div className="flex items-center justify-between py-1.5 border-b border-slate-100 dark:border-zinc-800/80">
          ...
          <button
            ...
            className="text-[10.5px] px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-zinc-300 hover:bg-slate-200 dark:hover:bg-zinc-700 flex items-center gap-1 font-medium transition cursor-pointer"
          >
        ...
        <div className="flex items-center justify-between py-1.5 border-b border-slate-100 dark:border-zinc-800/80">
          ...
          <button
            ...
            className="text-[10.5px] px-2.5 py-1 rounded-lg bg-rose-50 dark:bg-rose-950/80 text-rose-700 dark:text-rose-300 hover:bg-rose-100 dark:hover:bg-rose-900 border border-rose-200 dark:border-rose-800/60 flex items-center gap-1 font-bold transition cursor-pointer"
          >
        ...
        <div className="flex items-center justify-between py-1.5">
          ...
          <button
            ...
            className={`text-[10.5px] px-2.5 py-1 rounded-lg font-bold transition cursor-pointer ${
              notifState === 'granted'
